            ...
            {commentSelectID === item.icomment ? (
              ...
              <p
                dangerouslySetInnerHTML={{
                  __html: DOMPurify.sanitize(ctntSave),
                }}
              />
            )}
          ...
          {item.name === userDataName ? (
            <>
              {commentSelectID === item.icomment ? (
                <div>
                  <button
                    className="completeEditBt"
                    onClick={handleCompleteComment}
                  >
                    완료
                  </button>
                  <button
                    className="cancelDeleteBt"
                    onClick={e => handleCancelComment(item.icomment)}
                  >
                    취소
                  </button>
                </div>
                ...
                <div>
                  <button className="completeEditBt" onClick={toggleEditMode}>
                    수정
                  </button>
                  <button
                    className="cancelDeleteBt"
                    onClick={e => handleDeleteComment(item.icomment)}
                  >
                    삭제
                  </button>
                </div>
